                  ...
                  <li class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                    <a href="#" class="list-group-item list-group-item-action dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <div class="media d-flex align-items-center">
                        ...
                        <figure >
                          <svg xmlns="http://www.w3.org/2000/svg"  width="147px" height="109px" viewBox="0 0 147 109" version="1.1" class="injected-svg svg-inject img-fluid" >
                  ...
                  <li class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                    <a href="#" class="list-group-item list-group-item-action dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <div class="media d-flex align-items-center">
                        ...
                        <figure >
                          <svg xmlns="http://www.w3.org/2000/svg"  width="147px" height="110px" viewBox="0 0 147 110" version="1.1" class="injected-svg svg-inject img-fluid" >
                  ...
                  <li class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                    <a href="#" class="list-group-item list-group-item-action dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <div class="media d-flex align-items-center">
                        ...
                        <figure >
                          <svg xmlns="http://www.w3.org/2000/svg" width="131px" height="151px" viewBox="0 0 131 151" version="1.1" class="injected-svg svg-inject img-fluid" >
                  ...
                  <li class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                    <a href="#" class="list-group-item list-group-item-action dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <div class="media d-flex align-items-center">
                        ...
                        <figure >
                          <svg xmlns="http://www.w3.org/2000/svg"  width="148px" height="144px" viewBox="0 0 148 144" version="1.1" class="injected-svg svg-inject img-fluid" >
                  ...
                  <li class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                    <a href="#" class="list-group-item list-group-item-action dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <div class="media d-flex align-items-center">
                        ...
                        <figure >
                          <svg xmlns="http://www.w3.org/2000/svg"  width="153px" height="132px" viewBox="0 0 153 132" version="1.1" class="injected-svg svg-inject img-fluid" >
                  ...
                  <li class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                    <a href="#" class="list-group-item list-group-item-action dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <div class="media d-flex align-items-center">
                        ...
                        <figure >
                          <svg xmlns="http://www.w3.org/2000/svg" width="150px" height="151px" viewBox="0 0 150 151" version="1.1" class="injected-svg svg-inject img-fluid" >
                ...
                <ul class="list-group list-group-flush">
                  <li>
                    <a href="sections.html" class="list-group-item list-group-item-action" role="button">
                      <div class="media d-flex align-items-center">
                        <figure >
                          <svg xmlns="http://www.w3.org/2000/svg" width="145px" height="113px" viewBox="0 0 145 113" version="1.1" class="injected-svg svg-inject img-fluid" >
                  ...
                  <li>
                    <a href="docs/index.html" class="list-group-item list-group-item-action" role="button">
                      <div class="media d-flex align-items-center">
                        ...
                        <figure >
                          <svg xmlns="http://www.w3.org/2000/svg"  width="145px" height="149px" viewBox="0 0 145 149" version="1.1" class="injected-svg svg-inject img-fluid" >
                  ...
                  <li>
                    <a href="docs/components/index.html" class="list-group-item list-group-item-action" role="button">
                      <div class="media d-flex align-items-center">
                        ...
                        <figure >
                          <svg xmlns="http://www.w3.org/2000/svg"  width="143px" height="151px" viewBox="0 0 143 151" version="1.1" class="injected-svg svg-inject img-fluid" >
